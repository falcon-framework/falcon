...
export class CapabilityItem extends Schema.Class<CapabilityItem>(
  "CapabilityItem",
)({
  id: Schema.String,
  appId: Schema.String,
...
export class ConnectionItem extends Schema.Class<ConnectionItem>(
  "ConnectionItem",
)({
  id: Schema.String,
  organizationId: Schema.String,
...
export class ConnectionDetail extends Schema.Class<ConnectionDetail>(
  "ConnectionDetail",
)({
  id: Schema.String,
  organizationId: Schema.String,
...
export class CheckScopeBody extends Schema.Class<CheckScopeBody>(
  "CheckScopeBody",
)({
  connectionId: Schema.String,
  appId: Schema.String,
...
const AppId = HttpApiSchema.param("appId")(Schema.String);
const ConnectionId = HttpApiSchema.param("connectionId")(Schema.String);
...
const ApiGroup = HttpApiGroup.make("api")
  // GET /apps
  .add(
    HttpApiEndpoint.get("listApps", "/apps").addSuccess(
      Schema.Array(AppListItem),
    ),
  )
  // GET /apps/:appId/capabilities
  .add(
    HttpApiEndpoint.get("getCapabilities", "/apps/:appId/capabilities")
      .setPath(Schema.Struct({ appId: AppId }))
  ...
  .add(
    HttpApiEndpoint.post(
      ...
      "/installation-requests/:requestId/approve",
    )
      .setPath(Schema.Struct({ requestId: RequestId }))
  ...
  // GET /connections
  .add(
    HttpApiEndpoint.get("listConnections", "/connections").addSuccess(
      Schema.Array(ConnectionItem),
    ),
  )
  // GET /connections/:connectionId
  .add(
    HttpApiEndpoint.get("getConnection", "/connections/:connectionId")
      .setPath(Schema.Struct({ connectionId: ConnectionId }))
...
export const FalconConnectionApi = HttpApi.make("falcon-connection").add(
  ApiGroup.prefix("/v1"),
);
