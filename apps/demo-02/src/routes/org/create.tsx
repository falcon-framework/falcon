...
function CreateOrgPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (id) {
        localStorage.setItem("falcon-demo02:activeOrgId", id);
    ...
    <main className="page-wrap px-4 py-12">
      <div className="mx-auto max-w-md rounded-2xl border border-[var(--line)] bg-[var(--surface-strong)] p-8 shadow-sm">
        ...
        <p className="mb-6 text-sm text-[var(--sea-ink-soft)]">
          Use the same organization membership as on the source app when testing SSO, or create a
          workspace here if you have none yet.
        </p>
